    ...
    <>   
      <div class="h-[150px] bg-[#0102020]">
        <div class="h-[140px] overflow-hidden">
          ...
          <strong>SEU ESTILO DE VIDA SURF COMEÇA AQUI</strong>
          <p>
          ...
          <strong>QUIKSILVER: SURFAR É NOSSA PAIXÃO, A SURFWEAR É NOSSO NEGÓCIO</strong>
          <p>
        ...
        <button class="" onClick={() => {document.querySelector('plus').toggleClass("hidden");} }> 
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" class="h-[30px] w-[30px]">
            ...
            <g>
              <g>
                <rect x="14.3" y="9" fill="#010202" class="hover:hidden plus" width="1.4" height="12"/>
